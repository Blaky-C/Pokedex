...
public class CardView1Adapter extends RecyclerView.Adapter<CardView1Adapter.ViewHolder>{
    ...
    public CardView1Adapter(int[] cardImages, String[] numbers, String[] names) {
    ...
    @Override
    public CardView1Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        CardView cv = (CardView) LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view1, parent, false);
